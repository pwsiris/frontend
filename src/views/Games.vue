                        ...
                        >
                            ...
                            <div v-else class="p-4">
                                ...
                                <ul class="list-disc ml-3 sm:ml-5 sm:text-lg text-justify">
                                    ...
                                    <li>Заказ - донат сверх подаренной игры/ключа (или ещё непройденой игры у меня в библиотеке) в 1.5к ставит игру в приоритетную очередь (пишите про это явно)</li>
                                </ul>
                            </div>
                        </DialogPanel>
                    </TransitionChild>
