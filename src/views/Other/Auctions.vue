                        ...
                        >
                            <div class="p-6">
                                ...
                                <ul class="list-disc ml-3 sm:ml-5 sm:text-lg text-justify">
                                    ...
                                    <li>
                                        Опционально во время аукциона может быть возможность выкупить фильм за 2.000 руб./900 грн. одним донатом
                                    ...
                                    <li>Победитель аукциона (или несколько) выбирается через колесо рандома на выбывание</li>
                                    <li>Если тематика/серия некоторых фильмов из финального списка совпадают, то их можно посмотреть вместе</li>
                                    <li>Для тематических аукционов принимаются только определённые фильмы</li>
