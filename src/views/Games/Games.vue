                        ...
                        >
                            ...
                            <div v-else class="p-6">
                                ...
                                <ul class="list-disc ml-3 sm:ml-5 sm:text-lg text-justify">
                                    ...
                                    <li>Если работоспособность игры зависит от сторонних патчей и прочего (а не просто "скачай из стима и играй"), то заказчик должен предоставить необходимые инструкции и ресурсы. В противном случае возможен дроп уже оплаченной игры</li>
                                    <li>Прохождение может быть дропнуто, если игра багуется (как было с Tomb Raider) или ну совсем не зайдёт стримеру и/или чату</li>
                                    <li>
                                        <router-link
