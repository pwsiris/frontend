                        ...
                        >
                            ...
                            <div v-else-if="dataModal.name == '', dataModal.iframe_link == ''" class="p-6">
                                ...
                                <ul class="list-disc ml-3 sm:ml-5 sm:text-lg text-justify">
                                    <li>Сначала обсудить аниму с Миром (mirakzen) и опосредованно со стримером, только после договорённостей донат</li>
                                    <li>Просмотр может быть дропнут, если аниме ну совсем не зайдёт стримеру и/или чату или вызывает отторжение</li>
