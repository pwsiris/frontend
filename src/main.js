...
import { faEnvelope, faTrophy, faCircleDollarToSlot, faCircleUp, faArrowUpRightFromSquare, faXmark, faBars, faAngleDown, faImages, faLanguage, faGamepad, faHandshakeAngle, faListCheck } from '@fortawesome/free-solid-svg-icons'
...
library.add(
    ...
    faImages, faLanguage, faGamepad, faHandshakeAngle, faListCheck
)
